...
public class RecordSanitizer {
    private final DomXMLParser domXMLParser = new DomXMLParser();
    ...
    public Document sanitizeRecord(File xmlFile){
        try {
            ...
            removeWhereElementHasCondition("pc:accumulatorSpecification","pc:balanceGrouping","cb:catalogName","ACCUMULATOR_SPECIFICATION");
    ...
    public void removeWhereElementHasCondition(String tagName, String elementToRemove, String elementThatHasCondition, String condition){
