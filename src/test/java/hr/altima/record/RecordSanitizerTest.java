...
public class RecordSanitizerTest {
    ...
    private final RecordSanitizer recordSanitizer = new RecordSanitizer();
                ...
                for (int j = 0; j < elementList.getLength(); j++) {
                    ...
                    if (n.getNodeType() == Node.ELEMENT_NODE) {
                        ...
                        if (childNode.getTagName().equals("pc:name")) {
                            name = n;
                            System.out.println(
                                "set name to external reference so it can be changed in case domain is greater than 100");
                        }
    ...
    public static Document removeWhereElementHasCondition(Document newDoc, String tagName, String elementToRemove,
                                                          String elementThatHasCondition, String condition) {
    ...
    void testPriceCategoryName() {
        File xmlFile = new File(
            "C:\\Users\\Karlo\\IdeaProjects\\VanillaJavaApplication\\src\\test\\java\\record\\in\\example.xml");
        Document doc;
        try {
            ...
            try (FileOutputStream output =
                     new FileOutputStream(
                         "C:\\Users\\Karlo\\IdeaProjects\\VanillaJavaApplication\\src\\test\\java\\record\\out\\sanitized.xml")) {
    ...
    void testWhereElementHasCondition() {
        ...
        try {
            ...
            Document doc2 = removeWhereElementHasCondition(doc, "pc:accumulatorSpecification", "pc:balanceGrouping",
                "cb:catalogName", "ACCUMULATOR_SPECIFICATION");
